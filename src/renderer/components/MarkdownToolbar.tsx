...
const MarkdownToolbar: React.FC<MarkdownToolbarProps> = ({ onFormat, onToggleLineNumbers, showLineNumbers, isNoteEmpty, onNoteTypeChange }) => {
  return (
    <div className="markdown-toolbar">
      ...
      {isNoteEmpty && onNoteTypeChange && (
        <>
          <div className="toolbar-separator"></div>
          <button className="toolbar-btn" onClick={() => onNoteTypeChange('drawing')} title="Switch to Drawing">
